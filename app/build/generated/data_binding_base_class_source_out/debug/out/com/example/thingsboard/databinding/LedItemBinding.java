...
public final class LedItemBinding implements ViewBinding {
  @NonNull
  ...
  private LedItemBinding(@NonNull LinearLayout rootView, @NonNull ImageButton bianjiLed,
  ...
  @NonNull
  public static LedItemBinding inflate(@NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static LedItemBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
      boolean attachToParent) {
    View root = inflater.inflate(R.layout.led_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LedItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LedItemBinding((LinearLayout) rootView, bianjiLed, led, ledDevicesAddress,
